...
function y=ThreeStrainSimulatorRatio(t,x,inputs,par,input,output,K,T)
...
%Assigning the ratio parameters

%Computing the different input concentration with the given stochiometry
alpha=(alpha0+K(1)*x(3)*output1(1)+K(2)*x(6)*output2(1)+K(3)*x(31)*output3(1))/(1+K(1)*x(3)*output1(4)+K(2)*x(6)*output2(4)+K(3)*x(31)*output3(4)); %updating alpha
IAA=(IAA0+K(1)*x(3)*output1(2)+K(2)*x(6)*output2(2)+K(3)*x(31)*output3(2))/(1+K(1)*x(3)*output1(5)+K(2)*x(6)*output2(5)+K(3)*x(31)*output3(5)); %updating IAA
